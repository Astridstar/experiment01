...
The 'data_cleansing_experiment01' project was generated by using the lakeflow-pipelines template.
...
2. To deploy a development copy of this project, type:
    ...
    `[dev yourname] data_cleansing_experiment01_etl` to your workspace.
